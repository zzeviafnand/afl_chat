...
/// {@tool snippet}
///
/// If the profileImage is to have an image, the image should be specified in the
...
/// {@tool snippet}
///
/// If the profileImage is to just have the user's initials, they are typically
...
///  * [ListTile], which can combine an icon (such as a [CircleProfilePicture]) with
...
class CircleProfilePicture extends StatelessWidget {
  ...
  ///
  /// Typically a [Text] widget. If the [CircleProfilePicture] is to have an image, use
  /// [backgroundImage] instead.
  final Widget? child;

  /// The color with which to fill the circle. Changing the background
  /// color will cause the profileImage to animate to the new color.
  ///
  ...
  /// image will cause the profileImage to animate to the new image.
  ///
  /// Typically used as a fallback image for [foregroundImage].
  ///
  /// If the [CircleProfilePicture] is to have the user's initials, use [child] instead.
  ...
  /// The size of the profileImage, expressed as the radius (half the diameter).
  ///
  ...
  /// The minimum size of the profileImage, expressed as the radius (half the
  /// diameter).
  ///
  ...
  /// 20 when the [CircleProfilePicture] is in an unconstrained environment will cause
  /// the profileImage to animate from a 20 pixel diameter to a 40 pixel diameter.
  /// However, if the [minRadius] is 40 and the [CircleProfilePicture] has a parent
  /// [SizedBox] whose size changes instantaneously from 20 pixels to 40 pixels,
  /// the size will snap to 40 pixels instantly.
  final double? minRadius;

  /// The maximum size of the profileImage, expressed as the radius (half the
  /// diameter).
  ///
  ...
  /// 20 when the [CircleProfilePicture] is in an unconstrained environment will cause
  /// the profileImage to animate from a 20 pixel diameter to a 40 pixel diameter.
  /// However, if the [maxRadius] is 40 and the [CircleProfilePicture] has a parent
  /// [SizedBox] whose size changes instantaneously from 20 pixels to 40 pixels,
  /// the size will snap to 40 pixels instantly.
      ...
      child: child == null
          ...
          : Center(
              child: MediaQuery(
                ...
                // text doesn't escape the profileImage when the textScaleFactor is large.
