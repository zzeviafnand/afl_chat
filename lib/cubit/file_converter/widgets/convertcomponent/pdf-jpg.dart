...
class PdfToJpg extends StatefulWidget {
  const PdfToJpg({super.key});

  @override
  State<PdfToJpg> createState() => _PdfToJpgState();
}

class _PdfToJpgState extends State<PdfToJpg> {
  File file = File("");

  @override
  void initState() {
    super.initState();
    context.read<FileUploadCubit>().getFiles('pdf', 'pptx');
  }
    ...
    return BlocListener<OpenFileCubit, OpenFileState>(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            context.read<FileUploadCubit>().addFile('pdf', 'pptx');
          },
